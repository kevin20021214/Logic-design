...
set_property PACKAGE_PIN W19 [get_ports {volume_down}]						
	set_property IOSTANDARD LVCMOS33 [get_ports {volume_down}]
set_property PACKAGE_PIN T17 [get_ports {volume_up}]						
...
#Sch name = JA9
set_property PACKAGE_PIN H2 [get_ports {trig}]					
...
# ##Sch name = JB7
# set_property PACKAGE_PIN A15 [get_ports {left_pwm}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {left_pwm}]
# ##Sch name = JB8
# set_property PACKAGE_PIN A17 [get_ports {right_pwm}]					
# 	set_property IOSTANDARD LVCMOS33 [get_ports {right_pwm}]
##Sch name = JB9
...
#	set_property IOSTANDARD LVCMOS33 [get_ports {trig}]
##Sch name = JC8
#set_property PACKAGE_PIN M19 [get_ports {echo}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {echo}]
##Sch name = JC9
